...
<div class="p-11 inline-flex space-x-3 w-full">
    ...
    <div class="w-1/6 p-2 border border-1 border-gray-500">
        ...
        <form>
            <div class="">
            <a href="#" class="block bg-yellow-300 p-2 border cursor-pointer border-black text-sm w-full mt-1 focus:outline-none" wire:click.prevent="store({{ $product->id }}, '{{ $product->name }}', {{ $product->regular_price }})">
                    Add to Cart
            </a>
        </div>
    </form>
